...
#rb-boot .rb-mark{display:flex;align-items:baseline;gap:6px;font-family:'Bebas Neue',Impact,system-ui,sans-serif;line-height:1;transform:skewX(-7deg)}
#rb-boot .rb-mark b{font-weight:400;font-size:38px;letter-spacing:.02em;color:#E30613}
#rb-boot .rb-mark i{font-style:normal;font-size:28px;color:#FFD600}
#rb-boot .rb-mark s{text-decoration:none;font-size:14px;letter-spacing:.18em;color:#fff;padding-left:3px}
...
<div class="rb-mark"><b>RUN</b><i>&amp;</i><b>BIKE</b><s>HN</s></div>
